...
function DashboardContent({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="min-h-screen bg-transparent flex flex-col md:flex-row">
            {/* Mobile Header */}
            <div className="md:hidden flex items-center justify-between p-4 bg-white/50 backdrop-blur-xl border-b border-black/5 sticky top-0 z-30">
            ...
            {/* Sidebar */}
            <aside className={cn(
                "fixed inset-y-0 left-0 z-40 w-64 bg-white/80 backdrop-blur-xl border-r border-black/5 transition-transform duration-300 ease-in-out md:translate-x-0 md:static md:h-screen md:overflow-y-auto",
                ...
                <div className="flex flex-col h-full">
                    ...
                    <div className="p-4 md:hidden border-b border-black/5">
